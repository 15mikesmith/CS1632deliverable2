  ...
  class PrintClasses_test < Minitest::Test
    ...
    #Test to see whether printClasses method handles an invalid number
    ...
    #Test to see whether printClasses method handles a value greater than 1
    ...
    #Test to see whether printClasses method handles a single value equal to 1
