...
class StartingPos_test < Minitest::Test
  ...
  #Test to see whether startingPos method returns correct value given a random number
  ...
  #Test to see whether startingPos method returns correct value given a non numeric character
